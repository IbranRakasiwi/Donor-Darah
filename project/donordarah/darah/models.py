...
class Pasien(models.Model):
    ...
    ttl = models.CharField(max_length=240, null=True,blank=False)
    jenis_kelamin = models.CharField(max_length=6, null=True,blank=False)
    golongan_darah = models.CharField(max_length=6, null=True,blank=False)
    alamat_pasien = models.TextField(max_length=100, null=True,blank=False)
